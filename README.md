...
| **Databases**           | Amazon OpenSearch / Elastic Search (3rd party)                     | Elastic Search (3rd party)                     | Distributed search and analytics engine built on Apache Lucene.                                                           |
| **Databases**           | Amazon DocumentDB / Mongo Atlas (3rd party)                     | MongoDB Atlas (3rd party)                     | Fully managed, scalable, and reliable document database service compatible with MongoDB.                                                            |
...
| **Analytics**           | Amazon Managed Streaming for Apache Kafka (MSK)                             | Azure Event Hubs                           | Fully managed services for running Apache Kafka.                                             |
| **DevOps and Source Control** | AWS CodePipeline                       | Azure Pipelines/GitHub Actions     | Continuous integration and delivery (CI/CD) pipelines.                                         |
| **DevOps and Source Control** | AWS CloudFormation                     | Azure Resource Manager (ARM)              | Infrastructure-as-Code (IaC) for managing cloud resources.                                      |
...
| **Containers**          | AWS ECR                            | Azure Container Registry           | Repository for Docker images.                                                                         |
...
| **Messaging**| Amazon SES (Simple Email Service)                    | Azure Communication Services                        |  Cloud-based service for sending and receiving emails.                                                       |
...
| **Static Web Sites**| AWS Amplify/S3                    | Static Web Apps                       |  Deploys full stack web apps with CI/CD workflows, serverless APIs, and global content distribution.                                                       |
